...
# Configuration de l'affichage des compétences dans l'admin
...
# Configuration de l'affichage des messages de contact dans l'admin
...
# Configuration de l'affichage du profil dans l'admin
